...
def discounted_stage_cost(time_steps, discount_factor):
    if discount_factor is None:
        return None
    if time_steps == 0:
        return 0.0
    return float((1.0 - discount_factor ** time_steps) / (1.0 - discount_factor))
...
def build_run_metrics(
    *,
    ...
    total_stage_cost = float(time_steps)
    return {
        "strategy": strategy,
        "seed": seed,
        ...
        "discounted_cost": discounted_stage_cost(time_steps, discount_factor),
